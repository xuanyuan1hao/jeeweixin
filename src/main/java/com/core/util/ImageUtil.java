...
public class ImageUtil {
    ...
    public final static void scale2(String srcImageFile, String result, int height, int width, boolean bb) {
        try {
            try {
                File srcImageFileGood = new File(srcImageFile);
                JPEGImageDecoder decoder = JPEGCodec.createJPEGDecoder(new FileInputStream(srcImageFile));
                BufferedImage image2 = decoder.decodeAsBufferedImage();
                ImageIO.write(image2, "JPEG", srcImageFileGood);
...
//        // 1-缩放图像：
//        // 方法一：按比例缩放
//        ImageUtil.scale("d:/head.jpg", "d:/head2.jpg", 2, true);//放大
 //       ImageUtil.scale("d:/head.jpg", "d:/head3.jpg", 2, false);//缩小
//        // 方法二：按高度和宽度缩放
        ImageUtil.scale2("d:/head.jpg", "d:/abc_scale2.jpg", 20, 80, false);//测试OK
//        // 2-切割图像：
//        // 方法一：按指定起点坐标和宽高切割
