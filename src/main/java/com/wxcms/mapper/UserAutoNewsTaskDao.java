 ...
 */
public interface UserAutoNewsTaskDao {
    ...
    public List<UserAutoNewsTask> paginationEntity(UserAutoNewsTask searchEntity, Pagination<UserAutoNewsTask> pagination);
